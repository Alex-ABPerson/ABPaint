...
namespace ABPaint.Engine
{
    ...
    public static class SaveSystem
    {
        ...
        public delegate void ABPaintImportImageEventHandler(string path);
        public static event ABPaintImportImageEventHandler ImageImported;

        public delegate void ABPaintExportImageEventHandler(string path);
        public static event ABPaintExportImageEventHandler ImageExported;
